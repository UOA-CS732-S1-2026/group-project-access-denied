...
- **Flag placement**: Do not use popup modals for CTF flags. Place flags in
  descriptions, page text, API responses, comments, or other surfaces that feel
  natural to the challenge.
