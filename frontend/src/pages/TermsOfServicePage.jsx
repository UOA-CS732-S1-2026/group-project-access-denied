        ...
        <div className="space-y-12 text-on-surface-variant leading-relaxed font-light">
          ...
          <section>
            ...
            <p>
              ...
              those that may be retroactively applied at our sole and absolute discretion. Your
              agreement shall survive the heat death of the universe, or until our next terms update,
              whichever occurs first. Acceptance of these terms also constitutes acceptance of any
              future terms we may draft while half-asleep at 3 AM. If you are reading this sentence,
              congratulations, you are among the estimated 0.3% of internet users who actually read
              terms of service. We appreciate your diligence, though it will not entitle you to any
              discount, reward, or special treatment whatsoever.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">2. Eligibility</h2>
            <p>
              You must be at least 16 years of age to use our Services. By using the Services, you
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">3. Account Registration</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">4. Products and Pricing</h2>
            <p>
              ...
              product is listed at $0.00 due to a glitch, no, you may not order 10,000 units of it.
          ...
          <section>
            ...
            <p>
              ...
              the sale of counterfeit designer goods, which would be deeply ironic. All transactions
              are processed in New Zealand Dollars (NZD) unless otherwise stated. Currency conversion
              fees are imposed by your bank and are not within our control, though we do find them
              personally offensive on your behalf. If your payment is declined, we recommend checking
              your bank balance, trying another card, or reflecting on recent life choices.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              overly enthusiastic neighbourhood dogs, parcels left in rain by carriers who consider
              a doorstep to be &quot;sheltered,&quot; or parcels delivered to your neighbour who claims they
              &quot;never received anything.&quot; Estimated delivery windows are calculated using a
              proprietary algorithm that factors in distance, carrier performance, lunar phase, and
              general optimism. Express shipping means we will process your order with slightly more
              urgency and a marginally increased heart rate among warehouse staff. International
              customers acknowledge that customs delays are an inevitable part of the global shipping
              experience and agree not to send us angry emails about them more than twice per order.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              processed to the original payment method within 10 business days of receiving the
              returned item. Shipping costs for returns are the responsibility of the customer unless
              the return is due to a defective or incorrect product. Items returned with mysterious
              stains, pet hair, or the unmistakable scent of a nightclub will be classified as
              &quot;used&quot; regardless of what the return form states. Returning an item because &quot;it
              looked different on the model&quot; is valid, but we reserve the right to gently remind you
              that the model is 6&apos;1&quot; and professionally lit. Refund processing times are estimates,
              not guarantees — your bank may add additional delays for which we are not responsible
              but are deeply sympathetic. If you return more than 70% of your purchases within a
              12-month period, we may reach out to discuss whether online shopping is truly the right
              hobby for you.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">8. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">9. User Conduct</h2>
            <p>
              You agree to use the Services only for lawful purposes and in accordance with these
              Terms. You agree not to use the Services: (a) in any way that violates any applicable
              ...
              Services. Furthermore, you agree not to use the Services while operating heavy
              machinery, performing open-heart surgery, or engaging in any activity that requires
              your full and undivided attention. Any attempt to reverse-engineer our recommendation
              algorithm in order to make it suggest only discounted items is considered a violation
              of these Terms and, frankly, a bit rude. Users are prohibited from using automated
              bots, scripts, or trained parrots to interact with the Services on their behalf. If
              you discover a security vulnerability, please report it responsibly rather than
              exploiting it to order free cashmere sweaters.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">10. Privacy</h2>
            <p>
              Your use of the Services is also governed by our Privacy Policy, which is incorporated
              ...
              By using the Services, you consent to the collection and use of your information as
              described in the Privacy Policy. We are committed to protecting your personal data in
              accordance with applicable privacy legislation, including the New Zealand Privacy Act
              2020 and, where applicable, the General Data Protection Regulation (GDPR). We do not
              sell your personal data to third parties, though we occasionally whisper your first name
              to our servers as a term of endearment. Cookies are used to enhance your browsing
              experience and are not the edible kind, no matter how much we wish they were. We
              collect only the data necessary to provide our Services, improve your experience, and
              occasionally send you emails that you will mark as read without opening. Your browsing
              history within our store is visible only to our analytics team and is never used to
              make fun of you, even when you spend 45 minutes looking at socks.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              responsible for any arguments with partners, flatmates, or financial advisors that
          ...
          <section>
            ...
            <p>
              ...
              or fees (including reasonable legal fees) arising out of or relating to your violation
              of these Terms or your use of the Services. This indemnification obligation extends to
              any damages caused by your failure to follow washing instructions on garment labels, any
          ...
          <section>
            ...
            <p>
              ...
              You are expected to check this page periodically so that you are aware of any changes,
              as they are binding on you. We understand that nobody actually does this, which is why
              we occasionally hide important updates in the middle of long paragraphs like this one.
              If we make material changes, we may or may not notify you via email, depending on how
              material we consider the changes to be and whether our email server is feeling
              cooperative that day. Previous versions of these Terms are not archived publicly, so
              you cannot use the Wayback Machine to argue that we changed something. We reserve the
              right to update these Terms retroactively, prospectively, or in a quantum superposition
              of both states simultaneously.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">15. Governing Law and Jurisdiction</h2>
            <p>
              These Terms shall be governed by and construed in accordance with the laws of New
              Zealand, without regard to its conflict of law provisions. Any legal suit, action, or
              proceeding arising out of or related to these Terms or the Services shall be instituted
              exclusively in the courts of New Zealand, and you consent to the personal jurisdiction
              of such courts. Nothing in these Terms shall affect any non-waivable statutory rights
              that apply to you under the Consumer Guarantees Act 1993 or the Fair Trading Act 1986.
              In the unlikely event of a dispute that cannot be resolved through our customer support
              channels, both parties agree to first attempt mediation conducted over a civilised cup
              of tea before escalating to formal legal proceedings. Disputes regarding whether a
              garment is &quot;navy&quot; or &quot;dark blue&quot; shall be settled by a panel of three independent
              colour consultants whose decision shall be final and binding. Any arbitration shall
              take place in Auckland, New Zealand, and the losing party shall be responsible for
              providing high-quality pastries for all attendees.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">16. Severability</h2>
            <p>
              If any provision of these Terms is held to be invalid, illegal, or unenforceable for
              any reason, such provision shall be eliminated or limited to the minimum extent such
              that the remaining provisions of the Terms will continue in full force and effect. The
              invalidity of any single clause shall not affect the validity of the remaining clauses,
              much like how the removal of a single accessory from an outfit does not necessarily
              ...
              as CTF&#123;read_the_fine_print&#125;, are used for internal document integrity purposes and
          ...
          <section>
            <h2 className="text-xl font-bold text-on-surface mb-4">18. Contact Information</h2>
            <p>
